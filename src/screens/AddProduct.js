...
<SvgUri
    ...
    <Text style={{alignSelf:'center', fontSize:16, fontWeight:'400', color:'#7D8696'}}>{hours}:{minutes}</Text>
      ...
      <View style={{borderWidth:0,borderRadius:5,marginTop:20, borderColor:'#E3E3EB', height:50,paddingHorizontal:10, flexDirection:'row', justifyContent:'space-between'}}>


        <Text style={{alignSelf:'center', fontSize:18, fontWeight:'500', color:'#162741'}}>Linked products (0)</Text>
