...
const renderlist4 = ({ item, index }) => {
        ...
        return(
            ...
            style={{borderColor:'grey',marginTop:5,flexDirection:'row',  borderWidth:0.3, borderRadius:8 }}>

               <Image source={require('../images/photo-1523275335684-37898b6baf30.jpeg')} style={{height:80, width:'23%'}}/>
              <View style={{width:'40%',marginLeft:15, alignSelf:'center'}}>
                <Text style={{fontWeight:'700'}}>Product Name</Text>
                <Text style={{fontWeight:'700'}}>by Seller Name</Text>
              </View>
...
<View style={{  width:'100%',height:deviceHeight*0.08,backgroundColor:'white', paddingHorizontal:13, flexDirection:'column'}}>
  ...
  <Text style={{alignSelf: 'center', textAlignVertical: 'center', fontSize:18, fontWeight:'600'}}>Message Center</Text>
...
<ScrollView>
         ...
         <View style={{borderBottomWidth:0.25,borderTopWidth:0.25,backgroundColor:'#ECF0F1', marginTop:10, borderLeftWidth:0.25,borderRightWidth:0.25,borderColor:'#979A9A', justifyContent:'space-between', flexDirection:'row', padding:12,}}>
           <Text style={{color:'blue',fontSize:12, alignSelf:'center'}}>Buyer/Seller Messages</Text>
         ...
         <FlatList
                ...
                contentContainerStyle={{backgroundColor:'white', paddingHorizontal:1,  paddingBottom: 70}}
