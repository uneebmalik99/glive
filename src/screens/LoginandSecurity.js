...
<View style={{  width:'100%',height:deviceHeight*0.08,backgroundColor:'white', paddingHorizontal:13, flexDirection:'column'}}>
  ...
  <Text style={{alignSelf: 'center', textAlignVertical: 'center', fontSize:18, fontWeight:'600'}}>Login and Security</Text>
...
<View style={{flexDirection:'row',   justifyContent:'space-between'}}>
  <View style={{marginBottom:10,}}>
        ...
        <TextInput
        style={{marginTop:3,}}
        placeholder='Hernik.preget@presoft.de'
        placeholderTextColor='grey'
        />
  </View>
  <TouchableOpacity style={styles.button}>
...
<View style={{flexDirection:'row',   justifyContent:'space-between'}}>
  <View style={{marginBottom:10,}}>
        ...
        placeholderTextColor='grey'
        />
                <Text style={{color:'blue', marginLeft:15,marginTop:5,}}>Why add a mobile number?</Text>
...
<View style={{flexDirection:'row',   justifyContent:'space-between'}}>
  <View style={{marginBottom:10,}}>
        <Text>Two-Step Verification (2Sv) Settings:</Text>
        <TextInput
        style={{marginTop:3,}}
        placeholder='Manage your Two Step Verification (2Sv) Authenticators'
        placeholderTextColor='grey'
...
<View style={{flexDirection:'row',   justifyContent:'space-between'}}>
  <View style={{marginBottom:10,width:'80%'}}>
        ...
        style={{marginTop:3,}}
        multiline={true}
        placeholder='if you think glive account has been compromised, follow these steps to make your account more secure.'
        placeholderTextColor='grey'
        />
  </View>
  <TouchableOpacity style={styles.button}>
...
const styles = StyleSheet.create({
  ...
  item1: {
    borderWidth:0.4,borderColor:'#7B7D7D',borderRadius:2, padding:10,
  },
  itemall: {
    borderBottomWidth:0.4, borderRightWidth:0.4,borderLeftWidth:0.4 ,borderColor:'#7B7D7D',borderRadius:2, padding:10,
  },
  button:{
    borderRadius:3,
    justifyContent:'center',
