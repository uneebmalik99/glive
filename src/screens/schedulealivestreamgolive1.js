...
const schedulealivestreamgolive1 = ({route, navigation }) => {
...
<SvgUri
    ...
    <Text style={{alignSelf:'center', fontSize:16, fontWeight:'400', color:'#7D8696'}}>{time}</Text>
...
elevation: 5,
        ...
        <TouchableOpacity onPress={()=> {navigation.navigate('schedulealivestreamgolive')}} style={{marginTop:10, backgroundColor:'#162741',borderRadius:5, justifyContent:'center', height:deviceHeight*0.05, width:deviceWidth*0.2,}}>
          <Text style={{color:'white',fontSize:16,fontWeight:'500', alignSelf:'center'}}>Save</Text>
        </TouchableOpacity>
...
export default schedulealivestreamgolive1;
