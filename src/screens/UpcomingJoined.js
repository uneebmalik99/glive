...
const UpcomingJoined = ({ navigation }) => {
...
style={{width:'20%',justifyContent:'center',borderTopRightRadius:8,borderBottomRightRadius:8, backgroundColor:'red'}}>
  <Text style={{alignSelf:'center', color:'white'}}>Remove</Text>
</TouchableOpacity>
...
<View style={{  width:'100%',height:deviceHeight*0.08,backgroundColor:'white', paddingHorizontal:13, flexDirection:'column'}}>
  ...
  <Text style={{alignSelf: 'center', textAlignVertical: 'center', fontSize:18, fontWeight:'600'}}>Subscribed & Upcoming</Text>
