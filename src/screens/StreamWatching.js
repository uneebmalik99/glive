...
const StreamWatching = ({route, navigation }) => {
...
const renderProdductlist = ({ item, index }) => {
  ...
  return(
    ...
    return (
      ...
      <View style={{backgroundColor:'#C4C4C4', height:230, width:'100%'}}>
...
<Image  style={{alignSelf:'center', }} source={require('../images/Vector4.png')}/>
      ...
      <Text numberOfLines={null} style={{color:Appcolors.drakgrey}}>{item.CategoryDescription.length > 80 ? item.CategoryDescription.substring(0,80) +'...' : item.CategoryDescription}<Text >See more</Text> </Text> 
      ...
      <Text style={{color:'black',fontWeight:'700',fontSize:16 }}>Linked Products</Text> 
      ...
      <View style={{marginTop:15,width:'100%', paddingVertical:5,}}>
